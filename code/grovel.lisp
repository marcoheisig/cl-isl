...
(cenum #.(swig-lispify "isl_ast_expr_op_type" 'enumname)
       ...
       ((:isl-ast-expr-op-and-then "isl_ast_expr_op_and_then"))
       ((:isl-ast-expr-op-or "isl_ast_expr_op_or"))
       ((:isl-ast-expr-op-or-else "isl_ast_expr_op_or_else"))
       ...
       ((:isl-ast-expr-op-fdiv-q "isl_ast_expr_op_fdiv_q"))
       ((:isl-ast-expr-op-pdiv-q "isl_ast_expr_op_pdiv_q"))
       ((:isl-ast-expr-op-pdiv-r "isl_ast_expr_op_pdiv_r"))
       ((:isl-ast-expr-op-zdiv-r "isl_ast_expr_op_zdiv_r"))
       ...
       ((:isl-ast-expr-op-address-of "isl_ast_expr_op_address_of")))
